...
<div class="col-12">
    ...
    <div id="send_password_by_mail">
        <x-aboleon-inputable::checkbox :params="$account->id ? ['disabled'=> true] : []" name="send_password_by_mail" label="Envoyer le mot de passe par e-mail" value="send_password_by_mail" :affected="$error ? old('send_password_by_mail') : null"/>
    </div>
</div>
...
<x-aboleon-inputable::validation-error field="password"/>
