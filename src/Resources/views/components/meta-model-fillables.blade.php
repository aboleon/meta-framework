                            ...
                            <div class="row">
                                ...
                                @if ($schema)
                                    ...
                                    @foreach($collection['schema'] as $subkey => $value)
                                            ...
                                            @php
                                                ...
                                                if (!$model->store_in_content) {
                                                    $content_value = Cached::multilang() ? ($found_content[$subkey][$locale] ?? '') : ($found_content[$subkey] ?? '');
                                                } else {
                                ...
                                @else
                                    @php
                                        ...
                                        $single_content = $is_meta ? $model->meta : $content;


                                        $content_value = ($single_content && $key != '_media')
                                            ? (
                                                !$model->store_in_content
                                                    ? $single_content->translation($key, $locale)
                                                    : $single_content[$key]
                                            )
                                            : null;
                                    @endphp
