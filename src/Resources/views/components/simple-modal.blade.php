    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        jQuery_mfwSimpleModal.off().on('show.bs.modal', function (event) {
          ...
          jQuery_mfwSimpleModal.find('.modal-title').html(button.data('title')).end().find('.modal-body').html(button.data('body')).end().find('.btn-cancel').html(button.data('btn-cancel')).end().find('.btn-confirm').addClass(button.data('btn-confirm-class')).addClass(button.data('modal-id')).attr('data-model-id', button.data('model-id')).attr('data-identifier', button.data('identifier')).html(button.data('btn-confirm'));
