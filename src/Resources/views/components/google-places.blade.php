...
<div class="clearfix gmapsbar {{ $field }}" id="mapsbar_{{ $random_id }}">
    ...
    <div class="mb-3 row {{ $field }}_fields">
        <div class="mb-3 col-sm-4 col-street_number">
            <label for="geo_street_number_{{ $random_id }}" class="form-label">{{ trans('mfw.geo.street_number') }}</label>
        ...
        <div class="mb-3 col-sm-8 col-route">
            <label for="geo_route_{{ $random_id }}" class="form-label">{{ trans('mfw.geo.route') }}</label>
        ...
        <div class="mb-3 col-sm-4 col-postal_code">
            <label for="geo_postal_code_{{ $random_id }}" class="form-label">{{ trans('mfw.geo.postal_code') }}</label>
        ...
        <div class="mb-3 col-sm-8 col-locality">
            <label for="geo_locality_{{ $random_id }}" class="form-label">{{ trans('mfw.geo.locality') }}</label>
        ...
        <div class="mb-3 col-sm-4 col-administrative_area_level_2">
            <label for="geo_district_{{ $random_id }}" class="form-label">{{ trans('mfw.geo.district') }}</label>
        ...
        <div class="mb-3 col-sm-8 col-administrative_area_level_1">
            <label for="geo_region_{{ $random_id }}" class="form-label">{{ trans('mfw.geo.region') }}</label>
